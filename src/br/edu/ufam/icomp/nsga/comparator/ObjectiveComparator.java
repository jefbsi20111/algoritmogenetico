...
public class ObjectiveComparator implements Comparator {
  ...
  private static final int ADEQUACAO = 0;
  ...
  public int compare(Object o1, Object o2) {
    ...
    if(nObj==ADEQUACAO){
    	objetive1 = ((Individuo) o1).getAdequacao();
    	objetive2 = ((Individuo) o2).getAdequacao();
    	ascendingOrder_ = true;
    }else{
    	objetive1 = ((Individuo) o1).getCusto();
    	objetive2 = ((Individuo) o2).getCusto();
